                    ...
                    <tbody>
                        @foreach ($fournisseurs as $f)
                            <tr>
                                ...
                                <td> <a href=" {{route('transaction.list',$f->id)}} " class="btn btn-outline-success btn-block btn-sm">Affiche</a> </td>
                                <td>
                                    <select name="" id="" class="custom-select" onchange="window.location.href=this.value;">
                                            <option selected disabled>Action</option>
                                            <option value=" {{url('/backoffice/fournisseur/'.$f->id.'/show')}} ">Détails</option>
